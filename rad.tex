...
\begin{primer} U ovom primeru javlja se greška pri deljenju sa nulom odgovarajućih elemenata nizova a i b. Elementi nizova kojima rešavač nije dodelio vrednosti označeni su *.\\ \\
...
9	\hspace{0.15cm} \tab a[0]=0; \\
10	\hspace{-0.08cm} \tab a[3]=14; \\
11	\hspace{-0.08cm} \tab b[0]=10; \\
12	\hspace{-0.08cm} \tab b[2]=15; \\
13  \hspace{-0.08cm} \tab readInput(a, 5); \\
14  \hspace{-0.08cm} \tab readInput(b, 5); \\
15  \hspace{-0.08cm} \tab if(a[0] < b[0]) \\
16	\hspace{-0.08cm} \tab \tab	a[3]++; \\
17	\hspace{-0.08cm} \tab if(a[3] == b[2]) \\
18	\hspace{-0.08cm} \tab \tab	b[2]=0; \\
19	\hspace{-0.08cm} \tab return a[3]/b[2]; \\
20 \}
\end{minipage}
\hspace{1.1cm}
\begin{minipage}[t]{0.4\textwidth}
...
\end{primer} 
\par
U primeru \ref{example24} generiše se test primer za C program iz primera \ref{example23}. Navode se anotacije kojima se određuje redosled učitavanja elemenata nizova. 
...
16	\hspace{-0.08cm} \tab input\_value\_array(a, 1); \\
17  \hspace{-0.08cm} \tab if(a[0] < b[0]) \\
18	\hspace{-0.08cm} \tab \tab	a[3]++; \\
19	\hspace{-0.08cm} \tab if(a[3] == b[2]) \\
20	\hspace{-0.08cm} \tab \tab	b[2]=0; \\
21	\hspace{-0.08cm} \tab return a[3]/b[2]; \\
22 \}
\end{minipage}
\hspace{1.1cm}
\begin{minipage}[t]{0.4\textwidth}
...
primenjuju se razne aproksimacije. Ove aproksimacije mogu prijavljivati grešku u programu koja zapravo ne postoji. Iz tog razloga neophodno je pokretanjem
...
Eksperimentalni rezultati koji ukazuju na bolje performansi pri korišćenju rešavača Z3 u poređenju sa drugim SMT rešavačima dostupni su u literaturi \cite{z3improvements}. U radu je detaljno opisana upotreba rešavača korišćenjem SMT-LIB standarda i C++ interfejsa.
